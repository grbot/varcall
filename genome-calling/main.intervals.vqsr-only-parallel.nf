...
vcf_concat = Channel.fromPath("/cbio/users/gerrit/projects/refimpute/b37-panel1/nextflow-out-genome-calling-intervals-b37/v4/genome-calling/v4.vcf.gz")
vcf_concat_index = Channel.fromPath("/cbio/users/gerrit/projects/refimpute/b37-panel1/nextflow-out-genome-calling-intervals-b37/v4/genome-calling/v4.vcf.gz.tbi")
